...
public class ChipsDbSeeder implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        chip popchip = new chip("Popchips Potatoe Barbeque","{Insert description}",2.50,7,"https://d2lnr5mha7bycj.cloudfront.net/product-image/file/large_ef9a47fb-68b5-40ad-b88c-003db2b43e4e.jpg");
        chip doritos = new chip("Doritos Cool Ranch","{Insert description}",2.50,12,"https://images-na.ssl-images-amazon.com/images/I/91elpTzstuL._SY355AA355_PIbundle-64,TopRight,0,0_AA355_SH20_.jpg");
        ...
        chip stax = new chip("Stax All American Cheeseburger ","{Insert description}",2.50,8,"https://i5.walmartimages.com/asr/a0ec74b4-552e-4fa7-a051-89fe78939f6c_1.5a4c450f5cd8d9087438e4d380471ee3.jpeg?odnHeight=450&odnWidth=450&odnBg=FFFFFF");
        chip takis = new chip("Barcel Takis Fuego","{Insert description}",2.50,5,"https://static.meijer.com/Media/075/75280/0757528008680_a1c1_0600.png");
        chip ruffles = new chip("Ruffles Cheddar & Sour Cream","{Insert description}",2.50,6,"https://www.quill.com/is/image/Quill/s1063181_s7?$img400$");
