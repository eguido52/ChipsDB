...
public class ChipsDbSeeder implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        chip kettle = new chip("Honey Dijon Kettle Chips","Tangy Mustard seeks Love at first bite",2.61,10,"https://cdn.shopify.com/s/files/1/0558/1897/products/0003759_kettle-honey-dijon-chip.jpg?v=1450320427");
        chip veggie = new chip("Garden Veggie Straws","Sea Salt 30% less fat",2.99,3,"https://target.scene7.com/is/image/Target/GUEST_f11ee439-aaea-425d-aad9-0d9377e20dbe?wid=488&hei=488&fmt=pjpeg");
        chip sunchip = new chip("Harvest Cheddar Sunchips","Whole grain snack",3.29,5,"https://www.dollargeneral.com/media/catalog/product/cache/image/700x700/e9c3970ab036de70892d86c6d221abfe/0/0/00028400147392_0.jpg");
        chip popchip = new chip("Barbeque Popchips","Never fried always real",3.49,7,"https://d2lnr5mha7bycj.cloudfront.net/product-image/file/large_ef9a47fb-68b5-40ad-b88c-003db2b43e4e.jpg");
